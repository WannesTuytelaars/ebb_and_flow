...
def measure(required_concentrations, filename):
    ...
    if measured[12]<volume_end * 0.7: #this means almost all water that went to the plants didn't come back (33% of the water went to the plants)
        print("ALARM: there may be a leak in the system, water levels are very low!") 
    return measured

#source: https://numpy.org/doc/stable/reference/random/generated/numpy.random.triangular.html